<header class="mdl-layout__header mdl-color--grey-800 mdl-color-text--yellow-500 mdl-layout__header--waterfall">
  <div class="mdl-layout__header-row mdl-layout__header-row-sliver mdl-color-text--grey-800 mdl-color--yellow-500">
    <div class="mdl-layout-spacer"></div>
      <svg fill="#585755" height="18" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg">
